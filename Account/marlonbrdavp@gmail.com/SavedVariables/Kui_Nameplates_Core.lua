...
KuiNameplatesCoreSaved = {
	...
	["profiles"] = {
		["default"] = {
			...
			["level_text"] = true,
			["fade_non_target_alpha"] = 0.9000000357627869,
			["cvar_overlap_v"] = 0.5,
			...
			["frame_width_minus"] = 50,
			["castbar_name"] = false,
			["nameonly_damaged_friends"] = false,
			["auras_icon_normal_size"] = 20,
			["colour_friendly"] = {
				0.2745098039215687, -- [1]
				0.8196078431372549, -- [2]
				0.1411764705882353, -- [3]
			},
			["frame_height_target"] = 13,
			["mouseover_glow"] = true,
			["frame_height_minus"] = 10,
			["auras_side"] = 2,
			["frame_width_target"] = 105,
			["frame_height"] = 12,
			["colour_player"] = {
			...
			["cvar_enable"] = true,
			["castbar_name_vertical_offset"] = 4,
			["castbar_colour"] = {
